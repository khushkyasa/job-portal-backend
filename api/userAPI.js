...
userRouter.post("/register", async (req, res) => {
  ...
  res.status(201).json({ success: true, message: "Registration Completed Successfully", data: userResponse });
});
...
//Create first admin manually using a protected environment setup is recommended.
